interface Comilla2Props {
  size?: number; // Optional size prop for customization
}

const Comilla2: React.FC<Comilla2Props> = ({ size = 88 }) => (
  <svg height={size} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
